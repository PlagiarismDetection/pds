...
if __name__ == '__main__':
    ...
    """
    croff = CROffline(lang='vi')
    search_result = croff.retrieveCandidates(text, collection_vi, isPDF=False)
    ...
    """
    croff = CROffline(lang='en')
    search_result = croff.retrieveCandidates(text, collection_en, isPDF=False)
